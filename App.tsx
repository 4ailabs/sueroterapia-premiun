...
function App() {
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-blue-500 via-teal-500 to-emerald-500 relative overflow-hidden">
      ...
      <main className="min-h-screen flex flex-col items-center justify-center px-2 sm:px-4 py-4 w-full max-w-lg md:max-w-3xl lg:max-w-4xl mx-auto relative z-10">
        <SueroSelector />
      </main>
    </div>
  );
